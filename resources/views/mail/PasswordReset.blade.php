      ...
      <section>
        <div class="card">
          ...
          <div class="wrap-title">
            <h3>Hi,</h3>
            <p>Anda mendapatkan email ini karena kami menerima permintaan reset password untuk akun anda</p>
            <a href="{{ env('FE_LOGIN_URL') }}/reset-password?token={{ $token }}&email={{ $user->email }}" class="btn">Reset Password</a>
            <br>
            <p style="margin-top:1em">Link reset password ini akan kadaluarsa dalam {{ config('auth.passwords.'.config('auth.defaults.passwords').'.expire') }} Menit. Jika anda tidak meminta reset password, mohon hiraukan pesan ini. </p>
          </div>
        </div>
      </section>
