      ...
      <section>
        <div class="card">
          ...
          <div class="wrap-title">
            ...
            <p>Pemohon dengan nomor registrasi pengajuan <b>{{ $pengajuan->regId }}</b> telah menolak untuk melanjutkan ke proses selanjutnya, dengan komentar:
            </p>
            <i>{{ $pengajuan->keterangan }}</i>
